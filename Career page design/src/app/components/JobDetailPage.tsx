    ...
    >
      ...
      <main style={{ flex: 1 }}>
        ...
        >
          ...
          <div
            style={{
              ...
              flexDirection: "column",
              gap: "2.5rem",
              /* On mobile, sidebar shows below — keep natural order */
              order: 1,
            }}
          >
            <Section title="職位概覽">
            ...
            >
              ...
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns:
                    !isDesktop && !isMobile ? "1fr 1fr" : "1fr",
                  gap: "1rem",
              ...
              <button
                onClick={() =>
                  alert(
                    `Thanks for your interest in the ${job.title} role! Application form coming soon.`
                  )
                }
                style={{
                  width: "100%",
        ...
        >
          ...
          <button
            onClick={() =>
              window.open("https://www.locolla.com/contact/", "_blank")
            }
            style={{
              backgroundColor: "var(--primary)",
              color: "var(--primary-foreground)",
